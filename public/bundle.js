...
/***/ function(module, exports, __webpack_require__) {
	...
	var Post = __webpack_require__(211);
	...
	module.exports = React.createElement(
		...
		React.createElement(
			_reactRouter.Route,
			{ path: '/', component: Home },
			React.createElement(_reactRouter.Route, { path: ':slug', component: Post }),
			...
			var Posts = this.props.data.map(function (post) {
				return React.createElement(
					...
					React.createElement(
						_reactRouter.Link,
						{ to: post.slug },
						React.createElement('div', { dangerouslySetInnerHTML: { __html: post.title.rendered } })
					)
				);
			});
